						...
						<fieldset>
							...
							<ul class="reg_list">
								<li class="clear">
									...
									<input value="${memberVO.user_id}" name="user_id" type="text" class="w100p" id="user_id" placeholder="아이디을 입력해주세요"/>
		...
		$("#user_id").blur(function(){
			...
			$.ajax({
				...
				success:function(result){
					...
					$("#btn_submit").css({"cursor":"sursor","opacity":"0.5"});
					...
					$("#validation_idcheck").text("사용 가능한 아이디 입니다.");
					$("#validation_idcheck").css({"color":"green","font-size":"14px"});
					}
				},
				error:function(){
